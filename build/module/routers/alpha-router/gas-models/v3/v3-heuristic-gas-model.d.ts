...
export declare class V3HeuristicGasModelFactory extends IOnChainGasModelFactory {
    constructor();
    buildGasModel({ chainId, gasPriceWei, v3poolProvider: poolProvider, amountToken, quoteToken, l2GasDataProvider, providerConfig }: BuildOnChainGasModelFactoryType): Promise<IGasModel<V3RouteWithValidQuote>>;
    private estimateGas;
    /**
